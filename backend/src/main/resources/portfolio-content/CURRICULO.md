...
Desenvolvedor brasileiro apaixonado por criar soluções inovadoras e superar desafios técnicos. Atualmente atuando como estagiário em Gestão de Projetos na ANBIMA/Selic em convênio com o Banco Central, onde aplico minha afinidade com tecnologia para otimizar processos e melhorar a eficiência operacional.

Perfil curioso, focado em aprendizado contínuo e sempre com um projeto novo em mente. Especializado em desenvolvimento full-stack com foco em arquiteturas modernas, Clean Architecture e tecnologias enterprise.
...
- Gestão de projetos com foco em eficiência operacional
- Análise e melhoria de fluxos de trabalho
- Suporte na coordenação de atividades entre ANBIMA e Banco Central

## Formação Acadêmica

- **Graduação** - Em andamento (informações completas disponíveis no portfólio)
...
- **Signals** - Sistema de reatividade moderno
...
- **Power BI** - Análise de dados e BI
...
(Informações de certificações disponíveis no portfólio completo)
