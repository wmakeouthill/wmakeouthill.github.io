...
export class SkillsComponent {
  skills: Skill[] = [
    ...
    { name: 'FastAPI', levelKey: 'advanced', projectsCount: 2, category: 'backend', icon: 'python.svg' },
    { name: 'RAG (Retrieval-Augmented Generation)', levelKey: 'production', projectsCount: 2, category: 'backend', icon: 'python.svg' },
