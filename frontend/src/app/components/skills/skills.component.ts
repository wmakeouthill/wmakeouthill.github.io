...
export class SkillsComponent {
  skills: Skill[] = [
    ...
    { name: 'Vite', levelKey: 'advanced', projectsCount: 2, category: 'frontend', icon: 'typescript.svg' },
    { name: 'React Native', levelKey: 'advanced', projectsCount: 1, category: 'frontend', icon: 'react.svg' },
    { name: 'Electron', levelKey: 'advanced', projectsCount: 4, category: 'frontend', icon: 'electron.svg' },
    ...
    { name: 'FastAPI', levelKey: 'advanced', projectsCount: 3, category: 'backend', icon: 'python.svg' },
    { name: 'RAG (Retrieval-Augmented Generation)', levelKey: 'production', projectsCount: 3, category: 'backend', icon: 'python.svg' },
    { name: 'FAISS', levelKey: 'advanced', projectsCount: 2, category: 'backend', icon: 'python.svg' },
    ...
    { name: 'Google Vision API', levelKey: 'advanced', projectsCount: 1, category: 'backend', icon: 'google.svg' },
    ...
    { name: 'Evolution API (WhatsApp)', levelKey: 'advanced', projectsCount: 1, category: 'backend', icon: 'whatsapp.svg' },
    { name: 'gTTS / Text-to-Speech', levelKey: 'advanced', projectsCount: 1, category: 'backend', icon: 'python.svg' },
    { name: 'LangGraph', levelKey: 'production', projectsCount: 2, category: 'backend', icon: 'python.svg' },
    { name: 'Prophet (ML)', levelKey: 'advanced', projectsCount: 1, category: 'backend', icon: 'python.svg' },
    ...
    { name: 'SQLite', levelKey: 'advanced', projectsCount: 3, category: 'database', icon: 'database.svg' },
    ...
    { name: 'AWS EC2', levelKey: 'advanced', projectsCount: 2, category: 'devops', icon: 'cloud.svg' },
